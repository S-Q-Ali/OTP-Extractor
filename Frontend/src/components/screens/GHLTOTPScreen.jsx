...
import styles from "../../styles/GHLTOTP/GHLTOTP.module.css" // Add CSS module import

const GHLTOTP = ({ userEmail, qrCodeData, onContinue, showToast }) => {
  return (
