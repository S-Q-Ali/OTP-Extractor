...
class OTPInput {
    ...
    initializeOTPInputs() {
        ...
        otpInputs.forEach((input, index) => {
            input.addEventListener('input', (e) => this.handleInputChange(e, index, otpInputs));
            input.addEventListener('keydown', (e) => this.handleKeyDown(e, index, otpInputs));
            input.addEventListener('paste', (e) => this.handlePaste(e, index, otpInputs));
        });
    }
    ...
    handleInputChange(e, index, allInputs) {
        ...
        const otpInputs = container ? container.querySelectorAll('.otp-input') : allInputs;
    ...
    handlePaste(e, index, allInputs) {
        ...
        for (let i = 0; i < Math.min(pasteData.length, otpInputs.length - currentIndex); i++) {
